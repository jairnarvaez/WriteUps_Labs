"""
Django settings for WriteUps_Labs project.
...
ROOT_URLCONF = 'WriteUps_Labs.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'machines.context_processors.base_url',
            ],
        },
    },
]

WSGI_APPLICATION = 'WriteUps_Labs.wsgi.application'
...
REST_FRAMEWORK = {
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.AllowAny",  # default: cualquiera puede acceder
    ],
